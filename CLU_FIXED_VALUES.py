...
FIX_VALUES_JR = {'Temp_Allowance_Reason': 'T13', 'Change_of_IBD_Reason': '', 'Perm_Allowance_Reason': 'P02', 'Gender': 'Male',
              'Rank_Structure': 'RN', 'Type': 'Employee.Available for Assignment',  'PAYD/_LOS12/_GYH(S)': 'YNN',
              'Temp_Allowance_Location': 'UKBPF', 'Assignment_Type': 'Regular',
               'Location': 'HMS TRIUMPH',  'Untrained_Strength_Flag': 'No',
