...
SP_Lve_records = openbook.openbook('rotations.xls', sheet_type='LVE')
...
for lr in lrs:
    ...
    # this line selectes when we are going to start the block modification.
    mod_startdate = datetime.datetime(2015, 1, 1)
